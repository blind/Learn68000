...
namespace AkuSpriteEditor
{
    class CompZX
    {
        ...
        public static string txtOrg_Text = "&8000";
        public static int globals_GlobalsDone = 0;
        ...
        public static System.Drawing.Bitmap globals_LastFrame = null;
        ...
        public int[] globals_Colormap = new int[256*192];
        public int globals_ColormapSize;
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            if (cboEngine_Text.ToLower() != "akuyou")
            {
                ...
                globals_imagedata.Append("ld (StackRestore_Plus2-2),sp" + nl + "di" + nl + "ld " + myvar + ",&4000+" + VbX.CStr((VbX.CInt(txtxpos_text) / 1)) + "+" + (b2.Width / 8).ToString() + nl + nl);
            ...
            for (int y = 0; y < b.Height; y++)
            {
                ...
                for (int x = (validwidth) - 16; x >= 0; x -= 16)
                {
                    string thispair = GetPair(y, x);
                    string nextpair = GetPair(y, x - 16);
                    string thiscommand = "";
            ...
            DrawOrder += "  DEFW ColorMap_"+ Filename+ nl;
            globals_imagedata.Append("ColorMap_" + Filename +":"+ nl);
            globals_imagedata.Append("ld sp,&5B00" + nl);
            int multipushes = 0;
            for (int i = globals_ColormapSize - 1; i >= 0; i-=2) {
                String s ="";
                String s2 = "";
                s = s + VbX.Right("00"+VbX.Hex(globals_Colormap[i]),2);
                s = s + VbX.Right("00" + VbX.Hex(globals_Colormap[i - 1]), 2);
                s2 = MakeConverter("DE", globals_RegDE, s) ;
                if (s2.Length > 0)
                {
                    if (multipushes > 0) {
                        
                        if (multipushes < 4)
                        {   for (int mp = 0; mp < multipushes;mp++ )
                            {   globals_imagedata.Append("push de" + nl);
                            }
                        } else
                        {
                            int mp2 = multipushes;
                            if (mp2 > 40) mp2 = 40;
                            if (mp2 > globals_MaxDePush) globals_MaxDePush = mp2;
                            globals_DePushUsed[mp2] = true;
                            while (multipushes > 0)
                            {
                                int mm = multipushes;
                                if (mm > 40) mm = 40;
                                globals_imagedata.Append("call MultiPushDe" + mm.ToString() + nl);
                                multipushes -= 40;
                            }
                        }
                    }
         ...
         //   public int[] globals_Colormap = new int[256*192];
       // public int globals_ColormapSize;
            globals_imagedata.Append("  jp EndCode" + nl);
...
//       "ei" + VbX.Chr(13) + VbX.Chr(10) +
       ...
       //"add hl,sp" + VbX.Chr(13) + VbX.Chr(10) +
"   ld hl,&0000+31" + VbX.Chr(13) + VbX.Chr(10) +
"   add hl,sp" + VbX.Chr(13) + VbX.Chr(10) +
"	inc h" + VbX.Chr(13) + VbX.Chr(10) +
"	ld a,h" + VbX.Chr(13) + VbX.Chr(10) +
"	and  %00000111;7" + VbX.Chr(13) + VbX.Chr(10) +
"	jp nz,JumpToNextLineB" + VbX.Chr(13) + VbX.Chr(10) +
"	ld a,l" + VbX.Chr(13) + VbX.Chr(10) +
"	add a,%00100000;32" + VbX.Chr(13) + VbX.Chr(10) +
"	ld l,a" + VbX.Chr(13) + VbX.Chr(10) +
"	jp c,JumpToNextLineB" + VbX.Chr(13) + VbX.Chr(10) +
"	ld a,h" + VbX.Chr(13) + VbX.Chr(10) +
"	sub %00001000;8" + VbX.Chr(13) + VbX.Chr(10) +
"	ld h,a" + VbX.Chr(13) + VbX.Chr(10) +
"JumpToNextLineB: " + VbX.Chr(13) + VbX.Chr(10) +
...
"	push de" + VbX.Chr(13) + VbX.Chr(10) +
"	ld b,RLE_ImageWidth :ImageWidthE_Plus1" + VbX.Chr(13) + VbX.Chr(10) +
"	ld de,&000+RLE_ImageWidth :ImageWidthD_Plus2" + VbX.Chr(13) + VbX.Chr(10) +
"	add hl,de" + VbX.Chr(13) + VbX.Chr(10) +
"	inc h" + VbX.Chr(13) + VbX.Chr(10) +
"	ld a,h" + VbX.Chr(13) + VbX.Chr(10) +
"	and  %00000111;7" + VbX.Chr(13) + VbX.Chr(10) +
"	jp nz,JumpToNextLineBB" + VbX.Chr(13) + VbX.Chr(10) +
"	ld a,l" + VbX.Chr(13) + VbX.Chr(10) +
"	add a,%00100000;32" + VbX.Chr(13) + VbX.Chr(10) +
"	ld l,a" + VbX.Chr(13) + VbX.Chr(10) +
"	jp c,JumpToNextLineBB" + VbX.Chr(13) + VbX.Chr(10) +
"	ld a,h" + VbX.Chr(13) + VbX.Chr(10) +
"	sub %00001000;8" + VbX.Chr(13) + VbX.Chr(10) +
"	ld h,a" + VbX.Chr(13) + VbX.Chr(10) +
"JumpToNextLineBB: " + VbX.Chr(13) + VbX.Chr(10) +
"	pop de" + VbX.Chr(13) + VbX.Chr(10) +
"	ret" + VbX.Chr(13) + VbX.Chr(10);
           ...
           private void DoGlobalData(System.Drawing.Bitmap b2)
           {
               ...
               else
               {
                   ...
                   else
                   {
                       ...
                       // globals_globaldata.Append("ld hl,&0000+" + VbX.CStr(b2.Width / 8) + nl + "add hl,sp" + nl + "ld sp,hl" + nl);
                       //globals_globaldata.Append("jp nc,JumpToNextLine" + nl);
                       //globals_globaldata.Append("ld hl,&c050" + nl + "add hl,sp" + nl + "ld sp,hl" + nl);
                       globals_globaldata.Append("ld hl,&0000+31" + nl);
                       globals_globaldata.Append("add hl,sp" + nl);

                       globals_globaldata.Append("inc h" + nl);
                       globals_globaldata.Append("	ld a,h" + nl);
                       globals_globaldata.Append("	and  %00000111;7" + nl);
                       globals_globaldata.Append("	jp nz,JumpToNextLineB" + nl);
                       globals_globaldata.Append("	ld a,l" + nl);
                       globals_globaldata.Append("	add a,%00100000;32" + nl);
                       globals_globaldata.Append("	ld l,a" + nl);
                       globals_globaldata.Append("	jp c,JumpToNextLineB" + nl);
                       globals_globaldata.Append("	ld a,h" + nl);
                       globals_globaldata.Append("	sub %00001000;8" + nl);
                       globals_globaldata.Append("	ld h,a" + nl);
                       globals_globaldata.Append("JumpToNextLineB: " + nl);
                       globals_globaldata.Append("inc hl" + nl);
